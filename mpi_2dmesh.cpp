      ...
      int fromRank, int toRank ) 
{
   ...
   MPI_Datatype strided_send_type;
   MPI_Type_vector(sendHeight, sendWidth, srcWidth, MPI_FLOAT, &strided_send_type);
   MPI_Type_commit(&strided_send_type);
...
recvStridedBuffer(float *dstBuf, 
   ...
   MPI_Type_vector(expectedHeight, expectedWidth, dstWidth, MPI_FLOAT, &strided_recv_type);
